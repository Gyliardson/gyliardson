...
En mi puesto actual trabajo en todo el ciclo de entrega — arquitectura, implementación, despliegue, monitoreo, mantenimiento e infraestructura — incluyendo ingestión de documentos a gran escala, clasificación OCR, pipelines RAG, sincronización con SharePoint, automatización financiera, entornos Docker y CI/CD.
