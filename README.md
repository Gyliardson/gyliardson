...
In my current role, I work across the complete delivery cycle — architecture, implementation, deployment, monitoring, maintenance, and infrastructure — including large-scale document ingestion, OCR routing, RAG pipelines, SharePoint synchronization, financial automation, Docker environments, and CI/CD.
